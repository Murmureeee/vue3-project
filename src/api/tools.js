...
const handleAuthError = (errno) => {
  ...
  if (hasIn(authErrMap, errno)) {
    messageApi.error(authErrMap[errno])
    // 授权错误，登出账户
    // logout()
    return false
  }
...
export { handleRequestHeader, handleAuth, handleNetworkError, handleAuthError, handleGeneralError }
